        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              ...
              "<ul class='dropdown-menu'>" +
                ...
                "<li><div class='wysihtml5-colors' data-wysihtml5-command-value='#00E5BE'></div><a class='wysihtml5-colors-title' data-wysihtml5-command='foreColor' data-wysihtml5-command-value='#00E5BE'>" + locale.colours.#00E5BE + "</a></li>" +
              "</ul>" +
            "</li>";
        }
    };
