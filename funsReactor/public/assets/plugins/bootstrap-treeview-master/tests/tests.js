...
;(function () {
	...
	test('Options setup', function () {
		...
		var opts = {
			...
			selectedBackColor: 'dark#00E5BE',
			searchResultColor: 'yellow',
			searchResultBackColor: 'dark#00E5BE',
			enableLinks: true,
		...
		equal(options.onhoverColor, '#00E5BE', 'onhoverColor set ok');
		equal(options.selectedColor, 'yellow', 'selectedColor set ok');
		equal(options.selectedBackColor, 'dark#00E5BE', 'selectedBackColor set ok');
		equal(options.searchResultColor, 'yellow', 'searchResultColor set ok');
		equal(options.searchResultBackColor, 'dark#00E5BE', 'searchResultBackColor set ok');
